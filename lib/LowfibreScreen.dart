...
class LowfibreScreen extends StatelessWidget {
  const LowfibreScreen({Key? key}) : super(key: key);
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            child: Image.asset(
              'assets/image_25-removebg-preview.png', // Replace with your second image path
          ...
          Positioned(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.of(context).pushNamed('/familyhistoryScreen'); // Navigate to HPV Screen
              },
              child: Text(
                'Next',
                style: TextStyle(
